...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&kubeconfig, "kubeconfig", "k", "", "kubeconfig file (default is $HOME/.kube/config)")
	rootCmd.PersistentFlags().StringP("namespace", "n", v1.NamespaceDefault, "objects namespace")
